...
// TODO: Add a comment describing the functionality of the code below
//creating a new instance of Book model -- a new document in the books collection
Book.create(
  {
...
// and the instance that was created above
  //this instance does not contain all of the information possible to add, but it has all required fields
Book.create(
...
// TODO: Add a comment describing the difference between this instance being created
// and the instance that was created above
  //this instance does not include an author -- but the author field is NOT required
