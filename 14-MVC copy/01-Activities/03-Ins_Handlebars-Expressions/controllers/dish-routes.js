...
router.get('/dish/:num', async (req, res) => {
  ...
  //we are rendering one of these dishes which is hardcoded in here (it's an array, so we subtract 1 bc index of 0)
  //we are passing this dish object into our dishes.handlebars file
});
