...
const OmdbContainer = () => {
  ...
  // TODO: Fix the useEffect hook running after every request -- to be only when the page loads for the first time
  useEffect(() => {
  ...
  //button is clicked, and search value should go into searchMovie function to make the fetch request
