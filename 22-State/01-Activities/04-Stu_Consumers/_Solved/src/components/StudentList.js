        ...
        <>
          <section className="student-list">
            <table>
              ...
              <tbody>
                {students.map((student) => (
                  //mapping through students who exist
                  <tr key={student.id}>
                    <td>{student.id}</td>
                    <td>{student.name}</td>
                    <td>{student.major}</td>
            ...
            <div className="add-student">
              ...
              >
                {/* mapping through the majors and displaying each as a major */}
              ...
              <button
                type="button"
                onClick={() => {
                  // we are creating a new student, with the name and major coming from the state of the current students name and major
