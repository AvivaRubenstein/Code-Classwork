...
// Create a custom hook that allows easy access to our ThemeContext values
    //we want to be able to USE the context we are creating ---CONSUMER
export const useTheme = () => useContext(ThemeContext);

// Creating our theme provider. Accepts an argument of "props", here we plucking off the "children" object. ---PROVIDER
export default function ThemeProvider({ children }) {
  ...
  return (
    // Dark theme and toggle theme are getting provided to the child components
      //dark theme is the state, and toggleTheme is the way to update the state
