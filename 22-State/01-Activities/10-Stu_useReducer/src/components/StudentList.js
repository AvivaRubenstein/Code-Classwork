...
// TODO: Import our type variables --- the actionTypes!!
import {ADD_STUDENT, REMOVE_STUDENT, UPDATE_STUDENT, 
  ADD_MAJOR, REMOVE_MAJOR,
  SET_STUDENT_NAME, SET_STUDENT_MAJOR} from '../utils/actions'
                    ...
                    <td>
                      <button
                        ...
                        onClick={() => {
                          ...
                          // Your code here
                          //payload should contain the student's id
            ...
            <div className="add-student">
              ...
              <button
                ...
                onClick={() => {
                  ...
                  //payload should contain the new student's name and major
                  dispatch({
                    type: ADD_STUDENT,
                    payload: {
