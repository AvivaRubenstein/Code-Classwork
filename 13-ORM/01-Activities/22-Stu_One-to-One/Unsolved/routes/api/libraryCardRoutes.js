...
router.get('/', async (req, res) => {
  try {
    ...
    const libraryCardData = await LibraryCard.findAll({
      //bc we created a relationship between Reader and LibraryCard, we can grab data from one Model and 
      //all we have to do to join the tables is "include" the model: Reader
