...
function Student(first, last, age) {
  ...
  //Polymorphism:  we can pass a grade in either as a number OR a string
  //typeof input checks whether it is a string or a number, and handles those sitautions differently
