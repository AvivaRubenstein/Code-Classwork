...
describe("Logger", () => {
  describe("colors", () => {
    it("should print in black", () => {
      ...
      //we can spy on the console log
      const mock = jest.spyOn(console, "log");
      //we can override the normal functionality of the consolelog and not have it log anything
      mock.mockImplementation(() => {});

      log.black(message);
//we are checking that the console.log was called with the correct color
