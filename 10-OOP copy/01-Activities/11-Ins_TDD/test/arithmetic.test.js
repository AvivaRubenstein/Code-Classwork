...
describe("Arithmetic", () => {
  describe("Initialization", () => {
    //the number inside the arithmetic object should be true (Exists)
    it("should return an object containing a 'number' property when called with the 'new' keyword", () => {
      const obj = new Arithmetic();

      expect("number" in obj).toEqual(true);
    });
//we would expect number to be equal to the number we passed in 
...
//when we don't pass a number in it, it should be zero by default
