...
const phoneCall = (state) => ({
  //the phoneCall behavior returns an object with the method "call"
...
const Phone = (name, ringTone) => {
  ...
  //spread syntax allows us to take all of the key-value pairs of the object, and make it into a new object for the phone object
